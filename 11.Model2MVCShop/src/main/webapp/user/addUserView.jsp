...
<head>
	...
	<script type="text/javascript">
		...
		function fncAddUser() {
			...
			/////////////////////추가/////////////////////
			if($("strong#checkDupl h5").text().trim() == "중복된 아이디 입니다."){
			...
			$("input[name='userId']").on("keyup",function(){
				...
				$.ajax({
					...
					success:function(JSONData,status){
						...
						var displayData = "<h5>"+JSONData.result+"</h5>";
						
						
						$("strong#checkDupl h5").remove();
						$("strong#checkDupl").html(displayData);
		    ...
		    <div class="col-sm-4">
		      <input type="text" class="form-control" id="userId" name="userId" placeholder="아이디를 입력하세요" >
		       <span id="helpBlock" class="help-block">
		      	<strong class="text-danger" id="checkDupl"></strong>
		      </span>
		    </div>
		    <!--
		    <div class="col-sm-3">
